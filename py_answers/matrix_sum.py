"""
We define the Matrix Sum of a matrix as the maximum sum of matrix elements with each element
being the only one in his row and column. For example, the Matrix Sum of the matrix below 
equals 3315 ( = 863 + 383 + 343 + 959 + 767):

In other words its like sudoku, take the maximum value in each column, with no row overlap.
So you need to make a tie breaker when the same row gets used twice.
